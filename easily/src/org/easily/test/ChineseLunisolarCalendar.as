...
//===================================私有变量定义================================================
  ...
  public var cmonth:int;//农历月序列号
  public var cday:int;//农历日序列号
...
//======================================公有函数定义======================================
  ...
  public function getwFtv():String
  {
   ...
   {
    if (int(wFtv[i].substring(0,2)) == (m+1) && dateNWeek(y,m,int(wFtv[i].substring(2)),int(wFtv[i].substring(3))) == d)
    {
  ...
  public function getlFtv():String
  {
   ...
   {
    if (int(lFtv[i].substring(0,4)) == 100*(cmonth+1)+cday)
    {
