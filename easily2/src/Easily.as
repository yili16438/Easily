package
{
	...
	import com.ojuju.colorpicker.ColorPicker;
	import com.probertson.utils.GZIPBytesEncoder;
	import com.riafan.controllers.LoaderTip;
	 ...
	 * @author Easily
	 */
	[SWF(width="1500", height="900", backgroundColor="0x999999")]
	dynamic public class Easily extends Sprite
	{
...
//			obj.f();
		...
		public function t42():void
		{
			...
			var pt = MathUtils.rayEx2(pt1, pt2, pt2, len)
			var pt = MathUtils.rayEx2(pt2, pt1, pt1, len)
		}
