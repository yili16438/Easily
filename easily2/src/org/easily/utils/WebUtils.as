package org.easily.utils
{
	...
	public class WebUtils
	{
		...
		//查询相应的参数，比如?id=123,Request(id)=123		
		...
		//取得附加参数
		public static function getParam(stage:Stage, prop:String):String
		{
			try
			{
		...
		//取得附加的整形参数
		public static function getParamInt(stage:Stage, prop:String):int
		{
			var param:String = getParam(stage, prop);
			var num:Number = Number(param);
			if (isNaN(num))
			{
				return 0;
			}
